...
project = 'Volume Backup Service'
otcdocs_repo_name = 'opentelekomcloud-docs/volume-backup-service'
# Those variables are required for edit/bug links

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/volume-backup-service/api-ref/'
otcdocs_doc_title = 'API Reference'
otcdocs_doc_type = 'api-ref'
otcdocs_service_category = 'storage'
otcdocs_service_title = 'Volume Backup Service'
otcdocs_service_type = 'vbs'
...
html_title = "Volume Backup Service - API Reference"
...
latex_documents = [
    ('index',
     'vbs-api-ref.tex',
    u'Volume Backup Service - API Reference',
